...
public class KakaoRestApiHelper {
    ...
    private String accessToken = "f8994c0b93adb9cdfcdfeb4b8b59b5d7";
    private String adminKey = "1cd87a3f587cedea454a4fb40889c485";

    public void setAccessToken(final String accessToken) {
        this.accessToken = "f8994c0b93adb9cdfcdfeb4b8b59b5d7";
    }

    public void setAdminKey(final String adminKey) {
        this.adminKey = "1cd87a3f587cedea454a4fb40889c485";
    }

    
    public String readyPay(final Map<String, String> params) {
        return request(HttpMethodType.POST, PAY_READY_PATH, mapToParams(params));
    }
