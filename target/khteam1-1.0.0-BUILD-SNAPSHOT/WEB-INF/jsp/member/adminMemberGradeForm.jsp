                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								...
								<form action="/admin2/updateGrade.do" method="post">
									<table class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td>비밀번호 : ${map.PASSWORD} <input type="hidden" name="PASSWORD" value="${map.PASSWORD}"/></td>
										</tr>
										<tr>
											<td>이름 : ${map.NAME}</td>
										</tr>
										...
										<tr>
											<td>이메일 : ${map.EMAIL} <input type="hidden" name="EMAIL" value="${map.EMAIL}"/></td>
										</tr>
										<tr>
											<td>휴대폰번호 : ${map.PHONE} <input type="hidden" name="PHONE" value="${map.PHONE}"/></td>
										</tr>
										<tr>
											<td>마일리지번호 : ${map.MILE_NO}</td>
										</tr>
										<tr>
											<td>회원등급 : <input type="text" name="GRADE" value="${map.GRADE}"/></td>
										</tr>	
                                    </table>
