...
<div id="wrapper">
				...
				<ul>
					...
					<li id="member">
						...
						<ul>
							...
							<li><a href="/myPage/viewMember.do">마이페이지</a></li>
						</ul>
						</c:if>
	...
	<div class="tab" data-section="1">
		...
		<div class="tab-headline">
			...
			<form action="/book/flightSearch.do" method="post">
...
<div id="member_form">
	<div id="login_form">
		<form  action="/login/loginCheck.do" id="loging" autocomplete="on" method="post"> 
			<p> 
...
<div id="join-wrap">
	...
	<div id="join-form">
		<form action="/join/insertMember.do" id="join3" method="post">
			<h2>회원가입</h2>
